...
%Check if a field name is included in the data.
function hasField = HasField(data , name)
    arr_size = size(data.configinfo , 2);
    hasField = -1;
    for i=1:arr_size
        if(strcmp(data.configinfo(i).name  , name) == 1)
            hasField = i;
        end
    end
