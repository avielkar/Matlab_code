...
dir = 'C:\Matlab_code\New Configuration\Matlab_Login\';  %for adam's computer
...
RECORDEMAIL = 'adam.zaidel@biu.ac.il'; % Adam 


% Administrators' email
%ADMINEMAIL = 'jianchen@cns.bcm.edu'; % Jian chen
ADMINEMAIL = 'adam.zaidel@biu.ac.il'; % Adam 
ADMINEMAIL2 = 'adam.zaidel@biu.ac.il'; % Adam 

% Email server
%SMTP_SERVER = 'pcg.wustl.edu';
%SMTP_SERVER = 'cns.bcm.edu';
SMTP_SERVER = 'biu.ac.il';
...
SUBJECT_PARA_DIR = 'C:\Matlab_code\New Configuration\Subject_Context\';
