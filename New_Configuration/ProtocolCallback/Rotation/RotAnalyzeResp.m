function analyzeResp(appHandle,HR)

global  debug %connected

if debug
    disp('Entering RotAnalyzeResp')
end
...
if data.configinfo(i).parameters == 1   % For single interval
    ...
    if ~isempty(strmatch('Rotation Amplitude 2nd Int',{char(data.condvect.name)},'exact'))
