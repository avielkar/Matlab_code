...
if iDirLeftPriorVes>0
    plot(sortDirLeftPriorVes, sortRightLeftPriorVes, '+b');
    hold on;
end

if iDirLeftPriorVisual>0
    plot(sortDirLeftPriorVisual, sortRightLeftPriorVisual, 'xr');
    hold on;
end

if iDirLeftPriorCombined>0
    plot(sortDirLeftPriorCombined, sortRightLeftPriorCombined, 'og');
    hold on;
end
%%
...
if iDirRightPriorVes>0
    plot(sortDirRightPriorVes, sortRightRightPriorVes, '+b');
    hold on;
end

if iDirRightPriorVisual>0
    plot(sortDirRightPriorVisual, sortRightRightPriorVisual, 'xr');
    hold on;
end

if iDirRightPriorCombined>0
    plot(sortDirRightPriorCombined, sortRightRightPriorCombined, 'og');
    hold on;
end
%%

%% Plot on the same graph the axes pf the graph.
...
plotData.iDir = iDirLeftPriorCombined;
plotData.dirArray = dirArrayLeftPriorCombined;
plotData.dirRepNum = dirRepNumLeftPriorCombined;
plotData.rightChoice = rightChoiceLeftPriorCombined;

plotData.iDirVisual = iDirLeftPriorVisual;
plotData.dirArrayVisual = dirArrayLeftPriorVisual;
plotData.dirRepNumVisual = dirRepNumLeftPriorVisual;
plotData.rightChoiceVisual = rightChoiceLeftPriorVisual;

plotData.iDirVes = iDirLeftPriorVes;
plotData.dirArrayVes = dirArrayLeftPriorVes;
plotData.dirRepNumVes = dirRepNumLeftPriorVes;
plotData.rightChoiceVes = rightChoiceLeftPriorVes;
%%
